...
const UndrawTakenIcon: React.FC<SvgProps> = (props) => (
  <svg
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        xlinkHref="#aba94383-0ea8-4a3d-bf3d-6bf7d0bb624b"
      />
      <linearGradient
    ...
    <ellipse cx="432" cy="132.31" rx="143.21" ry="110.94" fill="#1aaaba" />
    <path
...
export default UndrawTakenIcon;
