...
export function SidebarItem({
    ...
    active,
    alert,
    onClick, // Agrega onClick como una prop
}: {
    icon: React.ReactNode;
    text: string;
    active: boolean;
    alert: boolean;
    onClick?: () => void; // Define onClick como una función opcional sin argumentos
}) {
    ...
    return (
        <li
            ...
            onClick={onClick} // Asigna la función onClick al evento onClick del elemento
        >
            {icon}
            <span
